...
export const ComponentResizeTab = ({
  resizeAlgorithm,
  setResizeAlgorithm,
  resizePreset,
  setResizePreset,
      ...
      <Grid item xs={6}>
        <FormControl fullWidth>
          ...
          <Select
            ...
            onChange={e => setResizeAlgorithm(e.target.value as string)}
          >
        ...
        <FormControl fullWidth>
          ...
          <Select
            ...
            onChange={e => {
              ...
              const presetVal = Number(e.target.value) / 100;
      ...
      <Grid item xs={6}>
        <TextField
          ...
          onChange={e => {
            ...
            if (resizeMaintainAspect && val !== '' && aspectRatio > 0) {
