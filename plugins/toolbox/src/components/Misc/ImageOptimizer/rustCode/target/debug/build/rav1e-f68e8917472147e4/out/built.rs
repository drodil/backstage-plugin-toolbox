...
#[allow(dead_code)]
pub static FEATURES: [&str; 4] = ["ASM", "CC", "NASM_RS", "THREADING"];
#[doc=r#"The features as a comma-separated string."#]
#[allow(dead_code)]
pub static FEATURES_STR: &str = "ASM, CC, NASM_RS, THREADING";
#[doc=r#"The features as above, as lowercase strings."#]
#[allow(dead_code)]
pub static FEATURES_LOWERCASE: [&str; 4] = ["asm", "cc", "nasm_rs", "threading"];
#[doc=r#"The feature-string as above, from lowercase strings."#]
#[allow(dead_code)]
pub static FEATURES_LOWERCASE_STR: &str = "asm, cc, nasm_rs, threading";
