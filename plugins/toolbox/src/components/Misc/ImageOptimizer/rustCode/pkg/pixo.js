 ...
 * @returns {Uint8Array}
 */
export function pixo_compress(input_data, qual, img_type) {
  ...
  const ret = wasm.pixo_compress(ptr0, len0, qual, ptr1, len1);
  if (ret[3]) {
...
/**
 * @param {Uint8Array} input_data
 * @param {string} resize_algorithm
 * @param {string} img_type
 * @param {number} dst_width
 * @param {number} dst_height
 * @returns {Uint8Array}
 */
export function pixo_resize(
  input_data,
  resize_algorithm,
  img_type,
  dst_width,
