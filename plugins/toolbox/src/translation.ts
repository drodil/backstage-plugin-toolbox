  ...
  messages: {
    ...
    tool: {
      ...
      'csr-generate': {
        ...
        stateOrProvinceNameLabel: 'State or Province Name',
        localityNameLabel: 'Locality Name',
        organizationNameLabel: 'Organization Name',
        organizationalUnitNameLabel: 'Organizational Unit Name',
        emailAddressLabel: 'Email Address',
        certificateRequestLabel: 'Certificate Request',
        decodedCSRLabel: 'Decoded CSR',
      },
      'bar-code-generate': {
        name: 'Barcode',
